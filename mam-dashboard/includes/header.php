...
<body>
    <div class="header">
        <h1>🔍 MAM IRC Analytics Dashboard</h1>
        ...
        <div class="tabs">
            ...
            <a href="?tab=invites" class="tab <?= $tab == 'invites' ? 'active' : '' ?>">🎫 Queue Tracking</a>
            ...
            <a href="?tab=queue-history" class="tab <?= $tab == 'queue-history' ? 'active' : '' ?>">⏳ Queue History</a>
            ...
            <a href="?tab=support" class="tab <?= $tab == 'support' ? 'active' : '' ?>">🛟 Support Tracking</a>
            <a href="?tab=history" class="tab <?= $tab == 'history' ? 'active' : '' ?>">📅 Historical Trends</a>
            <a href="?tab=logs" class="tab <?= $tab == 'logs' ? 'active' : '' ?>">📖 Log Viewer</a>
