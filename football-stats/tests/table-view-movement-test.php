...
$db->exec('CREATE TABLE matches (competition_code TEXT, season_label TEXT, matchweek INTEGER, match_date TEXT)');
...
$db->exec("INSERT INTO matches VALUES ('TEST', '2025-2026', 1, '2025-08-03')");
