<?php
// TEAM SURVIVAL TRACKER (Championship) - Data queries
...
<div class="panel" style="border: 3px solid <?= $teamSecondary ?>; background: linear-gradient(135deg, <?= $teamPrimary ?> 0%, #2e3136 100%);">
    <div style="text-align: center;">
        ...
        <?php football_stats_render_combined_table_controls($tableView, $currentMainTab ?? '2025-2026', $currentLeague ?? 'championship', $currentSubTab ?? 'team-tracker'); ?>
    </div>
</div>
