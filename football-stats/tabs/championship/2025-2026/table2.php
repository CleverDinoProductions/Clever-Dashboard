...
if ($table_filter !== 'all') {
    $filteredStandings = football_stats_compute_filtered_standings($db, 'ELC', $_split_season, $table_filter, $halfway_games, 'league_table_ELC', $max_regular_mw, $_filter_max_date, null, $max_regular_mw);
...
$homeStandings = football_stats_compute_filtered_standings($db, 'ELC', $_split_season, 'home', $halfway_games, 'league_table_ELC', $max_regular_mw, $_filter_max_date);
$awayStandings = football_stats_compute_filtered_standings($db, 'ELC', $_split_season, 'away', $halfway_games, 'league_table_ELC', $max_regular_mw, $_filter_max_date);
