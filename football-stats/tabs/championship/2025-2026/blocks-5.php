 ...
 * The drop zone - heading to League One
 */
...
<div class="block-detail-page">
	...
	<div class="panel" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
		...
		<?php football_stats_render_table_view_controls($tableView, $currentMainTab ?? '2025-2026', $currentLeague ?? 'championship', $currentSubTab ?? 'blocks-5'); ?>
