<?php
/**
 * Playoff Battle - Teams 3rd to 6th
 */
...
<div class="panel" style="border-left: 4px solid #5865F2;">
	<h2>🎟️ Playoff Battle (3rd-6th)</h2>
	<?php football_stats_render_table_view_controls($tableView, $currentMainTab ?? '2025-2026', $currentLeague ?? 'championship', $currentSubTab ?? 'playoff'); ?>
	<p style="margin-top: 15px; font-size: 1.1em; color: #ddd;">
		Teams finishing 3rd to 6th enter the playoffs for a chance at promotion to the Premier League.
	</p>
