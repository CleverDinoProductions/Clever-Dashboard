...
$blockInfo = [
	...
	'color' => '#5865F2',
	'positions' => '3-6',
	'description' => 'Championship Playoff Qualification Zone'
];
...
<div class="block-detail-page">
	...
	<div class="panel" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
		...
		<?php football_stats_render_table_view_controls($tableView, $currentMainTab ?? '2025-2026', $currentLeague ?? 'championship', $currentSubTab ?? 'blocks-2'); ?>
		<p style="margin-top: 15px; font-size: 1.1em; color: #ddd;">
			<?php echo $blockInfo['description']; ?> - Teams finishing 3rd to 6th enter the playoffs for a chance at promotion to the Premier League.
		</p>
