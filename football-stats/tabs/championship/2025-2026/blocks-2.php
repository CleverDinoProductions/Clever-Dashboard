<?php
/**
 * Block 2: European Contenders (Positions 5-7)
 * Europa League & Conference League qualification zone
 */
...
$blockInfo = [
    ...
    'color' => '#5865F2',
    'positions' => '3-6',
    'description' => 'Playoff Contenders for promotion to the Premier League'
];
...
<div class="block-detail-page">
    ...
    <div class="panel" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
        ...
        <?php football_stats_render_combined_table_controls($tableView, $currentMainTab ?? '2025-2026', 'championship', $currentSubTab ?? 'blocks-2'); ?>
        <p style="margin-top: 15px; font-size: 1.1em; color: #ddd;">
            <?php echo $blockInfo['description']; ?> - Teams competing for Playoff Contenders for promotion to the Premier League.
        </p>
