            ...
            <div class="projection-card" style="border-left: 3px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <div class="projection-stats">
                    ...
                    <div class="proj-alert" style="background: rgba(255, 152, 0, 0.1); padding: 10px; border-radius: 5px; margin-top: 10px; border-left: 3px solid #FF9800;">
                        <strong>⚠️ PPG needed for playoff spot (75pts):</strong> <?php echo $ppgNeededFor75; ?>
                        <br>
                        <span style="font-size: 0.85em; color: #888;">Must gain <?php echo $pointsNeededFor75; ?> from <?php echo $remainingGames; ?> games</span>
                    </div>
                    <?php endif; ?>
                    <?php if ($projectedPoints < 88): ?>
                    <div style="background: rgba(255, 215, 0, 0.07); padding: 10px; border-radius: 5px; margin-top: 8px; border-left: 3px solid #FFD700;">
                        <strong style="color: #FFD700;">🏆 For auto promotion (88pts):</strong>
                        <span style="color: #FFD700; font-weight: bold;"> <?php echo $ppgNeededFor88; ?> PPG needed</span>
                        <br>
                        <span style="font-size: 0.85em; color: #888;">Need <?php echo $pointsNeededFor88; ?> more pts from <?php echo $remainingGames; ?> games</span>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
