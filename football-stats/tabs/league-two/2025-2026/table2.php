...
if ($table_filter !== 'all') {
    $filteredStandings = football_stats_compute_filtered_standings($db, 'L2', $_split_season, $table_filter, $halfway_games, 'league_table_L2', $max_regular_mw, $_filter_max_date, null, $max_regular_mw);
...
$homeStandings = football_stats_compute_filtered_standings($db, 'L2', $_split_season, 'home', $halfway_games, 'league_table_L2', $max_regular_mw, $_filter_max_date);
$awayStandings = football_stats_compute_filtered_standings($db, 'L2', $_split_season, 'away', $halfway_games, 'league_table_L2', $max_regular_mw, $_filter_max_date);
...
<div class="panel">
    ...
    <?php football_stats_render_table_filter_buttons($table_filter, $currentMainTab ?? '2025-2026', 'league-two', $currentSubTab ?? 'table-2'); ?>
    <p class="update-info">
