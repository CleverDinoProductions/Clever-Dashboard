...
if ($calcMode === 'by_date') {
    $tableView = football_stats_get_table_view_by_date($db, 'L2', 'league_table_L2', $currentMainTab ?? '2025-2026');
} else {
...
<div class="panel">
    ...
    <?php if ($calcMode === 'by_date'): ?>
        <?php football_stats_render_date_view_controls($tableView, $currentMainTab ?? '2025-2026', 'league-two', $currentSubTab ?? 'table-2'); ?>
    <?php else: ?>
