<?php
/**
 * Block 1: Auto Promotion (Positions 1-3)
...
$blockInfo = [
    ...
    'color' => '#FFD700',
    'positions' => '1-3',
    'description' => 'Automatic Promotion to League One'
];
...
$teams = array_values(array_filter($tableView['standings'], function ($team) {
    return $team['position'] >= 1 && $team['position'] <= 3;
}));
...
<div class="block-detail-page">
    ...
    <div class="panel" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
        ...
        <?php football_stats_render_combined_table_controls($tableView, $currentMainTab ?? '2025-2026', 'league-two', $currentSubTab ?? 'blocks-1'); ?>
        <p style="margin-top: 15px; font-size: 1.1em; color: #ddd;">
            <?php echo $blockInfo['description']; ?> - The top 3 teams go straight up to League One without the lottery of the playoffs.
        </p>
    ...
    <div class="panel">
        ...
        <div class="projections-grid">
            <?php foreach ($teams as $team):
                ...
                $pointsNeededFor85 = max(0, 85 - $team['points']);
                $ppgNeededFor85 = $remainingGames > 0 ? round($pointsNeededFor85 / $remainingGames, 2) : 0;
            ?>
            <div class="projection-card" style="border-left: 3px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <div class="projection-stats">
                    ...
                    <div class="proj-alert" style="background: rgba(255, 152, 0, 0.1); padding: 10px; border-radius: 5px; margin-top: 10px; border-left: 3px solid #FF9800;">
                        <strong>⚠️ PPG needed for 85pts:</strong> <?php echo $ppgNeededFor85; ?>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
        ...
        <div class="benchmarks-grid">
            <div class="benchmark-card" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <ul>
                    ...
                    <li><strong>Season End (MD46):</strong> 90-95 points</li>
            ...
            <div class="benchmark-card" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <ul>
                    ...
                    <li><strong>Season End (MD46):</strong> 86-90 points</li>
                    <li><strong>Win Rate:</strong> 60-65%</li>
                </ul>
            </div>
            <div class="benchmark-card" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
                <h4>🥉 3rd Place (Last Auto Spot)</h4>
                <ul>
                    <li><strong>Target PPG:</strong> 1.9-2.1</li>
                    <li><strong>Halfway (MD23):</strong> 37-42 points</li>
                    <li><strong>Season End (MD46):</strong> 85-88 points</li>
                    <li><strong>Win Rate:</strong> 55-60%</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <!-- Historical Context -->
    <div class="panel">
        <h3>📜 Historical Block 1 Points (League Two)</h3>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                        ...
                        <td style="padding: 10px; text-align: center;">90-95 pts</td>
                    ...
                    <tr>
                        <td style="padding: 10px;"><strong>3rd - Last Auto Spot</strong></td>
                        <td style="padding: 10px; text-align: center;">85-88 pts</td>
                        <td style="padding: 10px; text-align: center;">37-42 pts</td>
        ...
        <div class="insight-box" style="background: rgba(255, 215, 0, 0.1); border-left: 3px solid <?php echo $blockInfo['color']; ?>; margin-top: 20px; padding: 15px; border-radius: 5px;">
            <h4>💡 Key Insight</h4>
            <p>
                In League Two, automatic promotion requires sustained excellence throughout the 46-game season.
                Teams that secure automatic promotion typically build their lead by Christmas and maintain consistency.
                The gap between 3rd (last auto spot) and 4th (playoff) averages <strong>4-8 points</strong> at season's end,
                making those final matchdays crucial.
            </p>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="block-navigation">
            ...
            <a href="<?php echo htmlspecialchars(build_tab_url($currentMainTab ?? '2025-2026', $currentLeague ?? 'league-two', 'blocks-dynamic', $tableViewNavParams), ENT_QUOTES, 'UTF-8'); ?>" class="nav-btn" style="background: rgba(255, 215, 0, 0.1); color: <?php echo $blockInfo['color']; ?>; border-color: <?php echo $blockInfo['color']; ?>;">🔥 Live Data</a>
