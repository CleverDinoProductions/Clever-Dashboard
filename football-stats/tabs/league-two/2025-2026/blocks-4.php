    ...
    <div class="panel">
        ...
        <div class="projections-grid">
            <?php foreach ($teams as $team):
                ...
                $pointsNeededFor47 = max(0, 47 - $team['points']);
                $ppgNeededFor47 = $remainingGames > 0 ? round($pointsNeededFor47 / $remainingGames, 2) : 0;
            ...
            <div class="projection-card" style="border-left: 3px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <div class="projection-stats">
                    ...
                    <div class="proj-row">
                        ...
                        <span class="proj-value">~47 pts</span>
                    </div>
                    <div class="proj-row">
                    ...
                    <div class="proj-alert" style="background: rgba(255, 165, 0, 0.1); padding: 10px; border-radius: 5px; margin-top: 10px; border-left: 3px solid #FFA500;">
                        <strong>🚨 PPG needed for survival (47pts):</strong> <?php echo $ppgNeededFor47; ?>
                        <br>
                        <span style="font-size: 0.85em; color: #888;">Must gain <?php echo $pointsNeededFor47; ?> points from <?php echo $remainingGames; ?> games</span>
                    </div>
                </div>
            </div>
            <?php endforeach; ?>
