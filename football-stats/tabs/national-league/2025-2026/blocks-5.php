...
/**
 * Block 5: Relegation Zone (Positions 23-24)
...
$teams = array_values(array_filter($tableView['standings'], function ($team) {
    return $team['position'] >= 23 && $team['position'] <= 24;
}));
...
<div class="block-detail-page">
    ...
    <div class="panel" style="border-left: 4px solid <?php echo $blockInfo['color']; ?>;">
        ...
        <?php football_stats_render_combined_table_controls($tableView, $currentMainTab ?? '2025-2026', 'national-league', $currentSubTab ?? 'blocks-5'); ?>
        <p style="margin-top: 15px; font-size: 1.1em; color: #ddd;">
            <?php echo $blockInfo['description']; ?> - Teams in the relegation zone facing the harsh reality of dropping to the National League North or South.
        </p>
    ...
    <div class="panel">
        ...
        <div class="projections-grid">
            <?php foreach ($teams as $team):
                ...
                // Get points to 22nd place from the active live/snapshot standings
                $team22nd = null;
                ...
                $gapTo22nd = $team22nd ? ((int) $team22nd['points'] - (int) $team['points']) : 0;
            ?>
            <div class="projection-card" style="border-left: 3px solid <?php echo $blockInfo['color']; ?>;">
                ...
                <div class="projection-stats">
                    ...
                    <div class="proj-row">
                        <span class="proj-label">Gap to 22nd (safety):</span>
                        <span class="proj-value" style="color: <?php echo $gapTo22nd <= 3 ? '#FFA500' : '#F44336'; ?>;">
                            <?php echo $gapTo22nd > 0 ? '-' . $gapTo22nd : '+' . abs($gapTo22nd); ?> pts
                        </span>
                    </div>
                    ...
                    <div class="proj-row">
                        ...
                        <span class="proj-value">~38 pts</span>
                    </div>
                    <div class="proj-row">
    ...
    <!-- Historical Context -->
    <div class="panel">
        <h3>📜 Historical Relegation Data</h3>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                        ...
                        <td style="padding: 10px; text-align: center;">&lt; 28 pts</td>
                        <td style="padding: 10px; text-align: center; color: #F44336;">95%+ Down</td>
                        <td style="padding: 10px; text-align: center; color: <?php echo $blockInfo['color']; ?>;"><strong>&lt; 0.74</strong></td>
                    </tr>
                    <tr style="border-bottom: 1px solid rgba(255,255,255,0.1);">
                        <td style="padding: 10px;"><strong>Usually Relegated</strong></td>
                        <td style="padding: 10px; text-align: center;">28-32 pts</td>
                        <td style="padding: 10px; text-align: center; color: #F44336;">75% Down</td>
                        <td style="padding: 10px; text-align: center; color: <?php echo $blockInfo['color']; ?>;"><strong>0.74-0.84</strong></td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: center; color: <?php echo $blockInfo['color']; ?>;"><strong>0.87-0.97</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
        <div class="insight-box" style="background: rgba(244, 67, 54, 0.1); border-left: 3px solid <?php echo $blockInfo['color']; ?>; margin-top: 20px; padding: 15px; border-radius: 5px;">
            <h4>💡 Harsh Reality</h4>
            <p>
                Teams in Block 5 face a monumental battle. Only <strong>20% of teams in the relegation zone at Christmas survive</strong>.
                The drop from the National League to National League North/South is enormous in financial, playing resources,
                and quality terms. Great escapes are possible but require a complete turnaround in form and mentality.
                Reaching 38 points is the minimum target — but even that may not be enough in a tight season.
            </p>
        </div>
    </div>
    ...
    <div class="panel">
        <div class="block-navigation">
            ...
            <a href="<?php echo htmlspecialchars(build_tab_url($currentMainTab ?? '2025-2026', $currentLeague ?? 'national-league', 'blocks-dynamic', $tableViewNavParams), ENT_QUOTES, 'UTF-8'); ?>" class="nav-btn" style="background: rgba(255, 215, 0, 0.1); color: #FFD700; border-color: #FFD700;">🔥 Live Data</a>
        </div>
    </div>
</div>
