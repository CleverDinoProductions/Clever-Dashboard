...
$_filter_max_mw = ($calcMode === 'by_matchweek' && !empty($tableView['active_matchweek']))
    ...
    : $max_regular_mw;
if ($table_filter !== 'all') {
    $filteredStandings = football_stats_compute_filtered_standings($db, 'NL', $_split_season, $table_filter, $halfway_games, 'league_table_NL', $_filter_max_mw, $_filter_max_date);
