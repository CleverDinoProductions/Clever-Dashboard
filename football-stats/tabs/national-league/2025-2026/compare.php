<?php
// National League 2025/26 Compare Tab
...
?>
<div class="panel">
    <h2>National League 2025/26 – Compare Tables</h2>
    <form method="get" style="margin-bottom: 18px; display:flex; gap:24px; align-items:center;">
        ...
        foreach (["tab", "league", "subtab"] as $param) {
            ...
            if ($val !== null) {
                ...
                if ($param === 'league') echo '<input type="hidden" name="league" value="national-league">';
